...
import { Store, Mail, Lock, User, Phone, Building, Eye, EyeOff } from 'lucide-react';
...
export default function SellerRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    alert('Registration successful! Please check your email to verify your account. Your account will be reviewed for approval.');
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Register as Seller</h1>
            <p className="text-gray-600">Start selling to millions of customers</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-blue-300 disabled:cursor-not-allowed mt-6"
            >
